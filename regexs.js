...
const NAME = /^[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð_'-].{1,30}$/
...
export { EMAIL, USER_NAME, TELEPHONE_BASIC, TELEPHONE_INTERNATIONAL, WEB_URL, POSTAL_ADDRESS }
